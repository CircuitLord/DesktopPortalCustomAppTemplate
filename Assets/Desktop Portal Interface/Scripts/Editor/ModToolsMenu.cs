...
namespace Desktop_Portal_Interface.Generated
{
    using UMod.Shared;
    ...
    public class ModToolsMenu
    {
        ...
        internal static void @__Startup()
        {
            if ((UnityEditor.EditorPrefs.GetBool("Desktop_Portal_Interface.firstrun") == false))
            {
                UnityEditor.EditorPrefs.SetBool("Desktop_Portal_Interface.firstrun", true);
